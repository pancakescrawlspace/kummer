...
#table(
  ...
  table.header([$p$], [class], [$d$], [$E^d (QQ_p)$], [base $g$], [$x(P)$],
               [image $(alpha; t)$]),
  [$3$], [$[1]$], [$7$], [$ZZ_3 times C_4$], [$(0,1)$], [$-3$], [$u$; $(1)$],
  [$3$], [$[u]$], [$-1$], [$ZZ_3 times C_4$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$3$], [$[p]$], [$3$], [$ZZ_3 times C_2$], [---], [$3$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$3$], [$[u p]$], [$6$], [$ZZ_3 times C_2$], [---], [$-3$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$5$], [$[1]$], [$1$], [$ZZ_5 times C_9$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$5$], [$[u]$], [$3$], [$ZZ_5 times C_3$], [$(3,1)$], [$3$], [$u$; $(2)$],
  [$5$], [$[p]$], [$5$], [$ZZ_5$], [---], [$4$], [$u$; ---],
  [$5$], [$[u p]$], [$-35$], [$ZZ_5$], [---], [$59004 slash 1369$], [$u$; ---],
  [$7$], [$[1]$], [$1$], [$ZZ_7 times C_5$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$7$], [$[u]$], [$-1$], [$ZZ_7 times C_11$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$7$], [$[p]$], [$7$], [$ZZ_7$], [---], [$-3$], [$u$; ---],
  [$7$], [$[u p]$], [$-7$], [$ZZ_7$], [---], [$424 slash 25$], [$u$; ---],
  [$11$], [$[1]$], [$3$], [$ZZ_11 times C_14$], [$(1,2)$], [$3$], [$u$; $(3)$],
  [$11$], [$[u]$], [$6$], [$ZZ_11 times C_10$], [$(8,2)$], [$-3$], [$u$; $(9)$],
  [$11$], [$[p]$], [$11$], [$ZZ_11 times C_2$], [---], [$22$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$11$], [$[u p]$], [$-11$], [$ZZ_11 times C_2$], [---], [$33 slash 4$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$13$], [$[1]$], [$-1$], [$ZZ_13 times C_18$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$13$], [$[u]$], [$5$], [$ZZ_13 times C_10$], [$(2,1)$], [$4$], [$u$; $(3)$],
  [$13$], [$[p]$], [$-13$], [$ZZ_13 times C_2$], [---], [$247$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$13$], [$[u p]$], [$26$], [$ZZ_13 times C_2$], [---], [$13$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$17$], [$[1]$], [$-1$], [$ZZ_17 times C_18$], [$(0,4)$], [$1$], [$u$; $(13)$],
  [$17$], [$[u]$], [$7$], [$ZZ_17 times C_18$], [$(14,4)$], [$-3$], [$u$; $(17)$],
  [$17$], [$[p]$], [$34$], [$ZZ_17 times C_2$], [---], [$85$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$17$], [$[u p]$], [$51$], [$ZZ_17 times C_2$], [---], [$-17$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$19$], [$[1]$], [$1$], [$ZZ_19 times C_21$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$19$], [$[u]$], [$-1$], [$ZZ_19$], [---], [$1$], [$u$; ---],
  [$19$], [$[p]$], [$95$], [$ZZ_19$], [---], [$59101 slash 121$], [$u$; ---],
  [$19$], [$[u p]$], [$-95$], [$ZZ_19$], [---], [$3723268224 slash 6105841$], [$u$; ---],
  [$23$], [$[1]$], [$1$], [$ZZ_23 times C_28$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$23$], [$[u]$], [$-1$], [$ZZ_23 times C_20$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$23$], [$[p]$], [$46$], [$ZZ_23 times C_2$], [---], [$3381 slash 625$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$23$], [$[u p]$], [$115$], [$ZZ_23 times C_2$], [---], [$-69$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$29$], [$[1]$], [$-1$], [$ZZ_29 times C_36$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$29$], [$[u]$], [$11$], [$ZZ_29 times C_24$], [$(4,9)$], [$22$], [$u$; $(5)$],
  [$29$], [$[p]$], [$-29$], [$ZZ_29 times C_2$], [---], [$87$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$29$], [$[u p]$], [$58$], [$ZZ_29 times C_2$], [---], [$-72682323 slash 1885129$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$31$], [$[1]$], [$1$], [$ZZ_31 times C_32$], [---], [$0$], [$u$; ord $32$ in $C_32$#super[\*]],
  [$31$], [$[u]$], [$-1$], [$ZZ_31 times C_30$], [---], [$1$], [$u$; ord $30$ in $C_30$#super[\*]],
  [$31$], [$[p]$], [$31$], [$ZZ_31 times C_2$], [---], [$93$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$31$], [$[u p]$], [$-62$], [$ZZ_31 times C_4$], [---], [$93$], [$u$; ord $4$ in $C_4$#super[\*]],
  [$37$], [$[1]$], [$-11$], [$ZZ_37 times C_48$], [$(1,7)$], [$220$], [$u$; $(19)$],
  [$37$], [$[u]$], [$6$], [$ZZ_37 times C_28$], [$(7,16)$], [$-3$], [$u$; $(5)$],
  [$37$], [$[p]$], [$-37$], [$ZZ_37 times C_2$], [---], [$8473 slash 16$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$37$], [$[u p]$], [$74$], [$ZZ_37 times C_2$], [---], [$91945 slash 1156$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$41$], [$[1]$], [$-1$], [$ZZ_41 times C_35$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$41$], [$[u]$], [$3$], [$ZZ_41 times C_49$], [$(1,18)$], [$3$], [$u$; $(27)$],
  [$41$], [$[p]$], [$41$], [$ZZ_41$], [---], [$-1328 slash 121$], [$u$; ---],
  [$41$], [$[u p]$], [$123$], [$ZZ_41$], [---], [$9146571 slash 625$], [$u$; ---],
  [$43$], [$[1]$], [$1$], [$ZZ_43 times C_34$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$43$], [$[u]$], [$-1$], [$ZZ_43 times C_54$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$43$], [$[p]$], [$-86$], [$ZZ_43 times C_2$], [---], [$26445 slash 169$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$43$], [$[u p]$], [$86$], [$ZZ_43 times C_2$], [---], [$-169979 slash 47089$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$47$], [$[1]$], [$-11$], [$ZZ_47 times C_30 times C_2$], [$(12,4),(2,0)$], [$33 slash 4$ #linebreak() $220$], [$u$; $(1, 1)$ #linebreak() $u$; $(28, 1)$],
  [$47$], [$[u]$], [$-149$], [$ZZ_47 times C_18 times C_2$], [$(3,6),(2,0)$], [$1639$ #linebreak() $8791 slash 25$], [$u$; $(12, 1)$ #linebreak() $u$; $(11, 1)$],
  [$47$], [$[p]$], [$94$], [$ZZ_47 times C_2 times C_2$], [$3 p, 21 p$], [$141$ #linebreak() $1833 slash 16$], [$u$; $(1, 0)$ #linebreak() $u$; $(1, 1)$],
  [$47$], [$[u p]$], [$705$], [$ZZ_47 times C_2 times C_2$], [$8 p, 40 p$], [$376$ #linebreak() $-2439159 slash 6400$], [$u$; $(1, 0)$ #linebreak() $u$; $(0, 1)$],
  [$53$], [$[1]$], [$11$], [$ZZ_53 times C_58$], [$(2,16)$], [$22$], [$u$; $(33)$],
  [$53$], [$[u]$], [$22$], [$ZZ_53 times C_50$], [$(2,21)$], [$2937 slash 196$], [$u$; $(3)$],
  [$53$], [$[p]$], [$53$], [$ZZ_53 times C_2$], [---], [$-10388 slash 289$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$53$], [$[u p]$], [$106$], [$ZZ_53 times C_2$], [---], [$25798969 slash 7396$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$59$], [$[1]$], [$1$], [$ZZ_59 times C_63$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$59$], [$[u]$], [$6$], [$ZZ_59 times C_57$], [$(1,28)$], [$-3$], [$u$; $(46)$],
  [$59$], [$[p]$], [$295$], [$ZZ_59$], [---], [$8251821 slash 49$], [$u$; ---],
  [$59$], [$[u p]$], [$-59$], [$ZZ_59$], [---], [$217697199204 slash 5358093601$], [$u$; ---],
  [$61$], [$[1]$], [$1$], [$ZZ_61 times C_50$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$61$], [$[u]$], [$7$], [$ZZ_61 times C_74$], [$(5,15)$], [$-3$], [$u$; $(59)$],
  [$61$], [$[p]$], [$-61$], [$ZZ_61 times C_2$], [---], [$10675 slash 81$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$61$], [$[u p]$], [$122$], [$ZZ_61 times C_2$], [---], [$2358325453 slash 110889$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$67$], [$[1]$], [$-221$], [$ZZ_67 times C_28 times C_2$], [$(4,30),(13,0)$], [$1326$ #linebreak() $1819 slash 9$], [$u$; $(20, 1)$ #linebreak() $u$; $(25, 0)$],
  [$67$], [$[u]$], [$51$], [$ZZ_67 times C_40 times C_2$], [$(1,28),(10,0)$], [$-17$ #linebreak() $-714 slash 25$], [$u$; $(9, 1)$ #linebreak() $u$; $(8, 1)$],
  [$67$], [$[p]$], [$2211$], [$ZZ_67 times C_2 times C_2$], [$2 p, 27 p$], [$28743$ #linebreak() $4623$], [$u$; $(0, 1)$ #linebreak() $u$; $(1, 0)$],
  [$67$], [$[u p]$], [$134$], [$ZZ_67 times C_2 times C_2$], [$26 p, 49 p$], [$-335 slash 4$ #linebreak() $94537 slash 196$], [$u$; $(0, 1)$ #linebreak() $u$; $(1, 0)$],
  [$71$], [$[1]$], [$1$], [$ZZ_71 times C_59$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$71$], [$[u]$], [$-1$], [$ZZ_71 times C_85$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$71$], [$[p]$], [$71$], [$ZZ_71$], [---], [$-47$], [$u$; ---],
  [$71$], [$[u p]$], [$-71$], [$ZZ_71$], [---], [$334272 slash 6889$], [$u$; ---],
  [$73$], [$[1]$], [$3$], [$ZZ_73 times C_72$], [$(3,9)$], [$3$], [$u$; $(1)$],
  [$73$], [$[u]$], [$-21$], [$ZZ_73 times C_76$], [$(6,5)$], [$15$], [$u$; $(31)$],
  [$73$], [$[p]$], [$146$], [$ZZ_73 times C_2$], [---], [$7081 slash 64$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$73$], [$[u p]$], [$-365$], [$ZZ_73 times C_2$], [---], [$121326 slash 169$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$79$], [$[1]$], [$1$], [$ZZ_79 times C_86$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$79$], [$[u]$], [$-1$], [$ZZ_79 times C_74$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$79$], [$[p]$], [$158$], [$ZZ_79 times C_2$], [---], [$5004161712613 slash 72071308521$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$79$], [$[u p]$], [$-158$], [$ZZ_79 times C_2$], [---], [$7760048840149 slash 57386598025$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$83$], [$[1]$], [$-22$], [$ZZ_83 times C_90$], [$(9,9)$], [$1177 slash 64$], [$u$; $(13)$],
  [$83$], [$[u]$], [$-11$], [$ZZ_83 times C_78$], [$(2,9)$], [$33 slash 4$ #linebreak() $220$], [$u$; $(51)$ #linebreak() $u$; $(13)$],
  [$83$], [$[p]$], [$83$], [$ZZ_83 times C_2$], [---], [$115702 slash 9$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$83$], [$[u p]$], [$166$], [$ZZ_83 times C_2$], [---], [$-7055 slash 64$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$89$], [$[1]$], [$1$], [$ZZ_89 times C_100$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$89$], [$[u]$], [$-7$], [$ZZ_89 times C_80$], [$(3,3)$], [$424 slash 25$], [$u$; $(57)$],
  [$89$], [$[p]$], [$178$], [$ZZ_89 times C_2$], [---], [$50010613 slash 58081$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$89$], [$[u p]$], [$-267$], [$ZZ_89 times C_2$], [---], [$13439267253561 slash 39505537600$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$97$], [$[1]$], [$1$], [$ZZ_97$], [---], [$0$], [$u$; ---],
  [$97$], [$[u]$], [$7$], [$ZZ_97 times C_99$], [$(2,35)$], [$-3$], [$u$; $(20)$],
  [$97$], [$[p]$], [$97$], [$ZZ_97$], [---], [$-3020977264272 slash 60834742609$], [$u$; ---],
  [$97$], [$[u p]$], [$485$], [$ZZ_97$], [---], [$607367181296288749204 slash 261353291940472081$], [$u$; ---],
  [$101$], [$[1]$], [$-1$], [$ZZ_101 times C_105$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$101$], [$[u]$], [$3$], [$ZZ_101 times C_99$], [$(3,9)$], [$3$], [$u$; $(1)$],
  [$101$], [$[p]$], [$101$], [$ZZ_101$], [---], [$-68$], [$u$; ---],
  [$101$], [$[u p]$], [$-2626$], [$ZZ_101$], [---], [$80987149350133 slash 43587835729$], [$u$; ---],
  [$103$], [$[1]$], [$1$], [$ZZ_103 times C_87$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$103$], [$[u]$], [$-1$], [$ZZ_103 times C_121$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$103$], [$[p]$], [$103$], [$ZZ_103$], [---], [$1433661 slash 625$], [$u$; ---],
  [$103$], [$[u p]$], [$2266$], [$ZZ_103$], [---], [$-811896233775 slash 535089424$], [$u$; ---],
  [$107$], [$[1]$], [$-7$], [$ZZ_107 times C_105$], [$(13,43)$], [$424 slash 25$], [$u$; $(46)$],
  [$107$], [$[u]$], [$-1$], [$ZZ_107 times C_111$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$107$], [$[p]$], [$-1605$], [$ZZ_107$], [---], [$2571$], [$u$; ---],
  [$107$], [$[u p]$], [$-107$], [$ZZ_107$], [---], [$348$], [$u$; ---],
  [$109$], [$[1]$], [$1$], [$ZZ_109 times C_123$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$109$], [$[u]$], [$6$], [$ZZ_109 times C_97$], [$(1,12)$], [$-3$], [$u$; $(63)$],
  [$109$], [$[p]$], [$109$], [$ZZ_109$], [---], [$33919060748052 slash 93717413689$], [$u$; ---],
  [$109$], [$[u p]$], [$654$], [$ZZ_109$], [---], [$15870885 slash 6889$], [$u$; ---],
  [$113$], [$[1]$], [$1$], [$ZZ_113 times C_125$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$113$], [$[u]$], [$3$], [$ZZ_113 times C_103$], [$(2,36)$], [$3$], [$u$; $(13)$],
  [$113$], [$[p]$], [$113$], [$ZZ_113$], [---], [$-160779984385773438752 slash 2170759046766859201$], [$u$; ---],
  [$113$], [$[u p]$], [$339$], [$ZZ_113$], [---], [$-129$], [$u$; ---],
  [$127$], [$[1]$], [$-6$], [$ZZ_127 times C_126$], [$(15,4)$], [$21$], [$u$; $(121)$],
  [$127$], [$[u]$], [$3$], [$ZZ_127 times C_130$], [$(3,9)$], [$3$], [$u$; $(1)$],
  [$127$], [$[p]$], [$254$], [$ZZ_127 times C_2$], [---], [$39963217 slash 20164$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$127$], [$[u p]$], [$-127$], [$ZZ_127 times C_2$], [---], [$3122041 slash 25600$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$131$], [$[1]$], [$53$], [$ZZ_131 times C_64 times C_2$], [$(0,42),(3,0)$], [$148$ #linebreak() $-10388 slash 289$], [$u$; $(3, 0)$ #linebreak() $u$; $(49, 1)$],
  [$131$], [$[u]$], [$-11$], [$ZZ_131 times C_68 times C_2$], [$(3,32),(76,0)$], [$33 slash 4$ #linebreak() $220$], [$u$; $(41, 1)$ #linebreak() $u$; $(25, 0)$],
  [$131$], [$[p]$], [$131$], [$ZZ_131 times C_2 times C_2$], [$5 p, 51 p$], [$655$ #linebreak() $5371 slash 25$], [$u$; $(1, 0)$ #linebreak() $u$; $(1, 1)$],
  [$131$], [$[u p]$], [$8646$], [$ZZ_131 times C_2 times C_2$], [$68 p, 91 p$], [$80565$ #linebreak() $-29168680211 slash 7425625$], [$u$; $(0, 1)$ #linebreak() $u$; $(1, 1)$],
  [$137$], [$[1]$], [$7$], [$ZZ_137 times C_126$], [$(5,24)$], [$-3$], [$u$; $(97)$],
  [$137$], [$[u]$], [$3$], [$ZZ_137 times C_150$], [$(3,9)$], [$3$], [$u$; $(1)$],
  [$137$], [$[p]$], [$274$], [$ZZ_137 times C_2$], [---], [$331123731117 slash 5803544761$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$137$], [$[u p]$], [$-411$], [$ZZ_137 times C_2$], [---], [$1101728244 slash 3508129$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$139$], [$[1]$], [$51$], [$ZZ_139 times C_42 times C_3$], [$(2,23),(93,43)$], [$-17$ #linebreak() $-714 slash 25$], [$u$; $(34, 1)$ #linebreak() $u$; $(19, 2)$],
  [$139$], [$[u]$], [$3$], [$ZZ_139 times C_154$], [$(1,68)$], [$3$], [$u$; $(71)$],
  [$139$], [$[p]$], [$139$], [$ZZ_139 times C_2$], [---], [$417 slash 4$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$139$], [$[u p]$], [$-139$], [$ZZ_139 times C_2$], [---], [$3892 slash 9$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$149$], [$[1]$], [$53$], [$ZZ_149 times C_68 times C_2$], [$(0,18),(13,0)$], [$148$ #linebreak() $-10388 slash 289$], [$u$; $(47, 0)$ #linebreak() $u$; $(38, 1)$],
  [$149$], [$[u]$], [$94$], [$ZZ_149 times C_82 times C_2$], [$(1,36),(40,0)$], [$141$ #linebreak() $1833 slash 16$], [$u$; $(50, 1)$ #linebreak() $u$; $(5, 0)$],
  [$149$], [$[p]$], [$-149$], [$ZZ_149 times C_2 times C_2$], [$11 p, 56 p$], [$1639$ #linebreak() $8791 slash 25$], [$u$; $(1, 0)$ #linebreak() $u$; $(0, 1)$],
  [$149$], [$[u p]$], [$13559$], [$ZZ_149 times C_2 times C_2$], [$42 p, 119 p$], [$20413$ #linebreak() $712634381069 slash 37982569$], [$u$; $(1, 1)$ #linebreak() $u$; $(0, 1)$],
  [$151$], [$[1]$], [$1$], [$ZZ_151 times C_154$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$151$], [$[u]$], [$-1$], [$ZZ_151 times C_150$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$151$], [$[p]$], [$755$], [$ZZ_151 times C_2$], [---], [$151$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$151$], [$[u p]$], [$453$], [$ZZ_151 times C_2$], [---], [$3366104446853292 slash 32473665853489$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$157$], [$[1]$], [$1$], [$ZZ_157 times C_171$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$157$], [$[u]$], [$5$], [$ZZ_157 times C_145$], [$(4,17)$], [$4$], [$u$; $(1)$],
  [$157$], [$[p]$], [$157$], [$ZZ_157$], [---], [$4195788 slash 2809$], [$u$; ---],
  [$157$], [$[u p]$], [$2355$], [$ZZ_157$], [---], [$22623639965396331 slash 4382453351761$], [$u$; ---],
  [$163$], [$[1]$], [$1$], [$ZZ_163 times C_189$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$163$], [$[u]$], [$-1$], [$ZZ_163 times C_139$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$163$], [$[p]$], [$978$], [$ZZ_163$], [---], [$933$], [$u$; ---],
  [$163$], [$[u p]$], [$815$], [$ZZ_163$], [---], [$-2464911059 slash 18309841$], [$u$; ---],
  [$167$], [$[1]$], [$-13$], [$ZZ_167 times C_144$], [$(3,72)$], [$247$], [$u$; $(119)$],
  [$167$], [$[u]$], [$-6$], [$ZZ_167 times C_192$], [$(2,71)$], [$21$], [$u$; $(161)$],
  [$167$], [$[p]$], [$334$], [$ZZ_167 times C_2$], [---], [$58617 slash 4$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$167$], [$[u p]$], [$-334$], [$ZZ_167 times C_2$], [---], [$743828521 slash 1444804$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$173$], [$[1]$], [$51$], [$ZZ_173 times C_86 times C_2$], [$(0,47),(16,0)$], [$-17$ #linebreak() $-714 slash 25$], [$u$; $(41, 0)$ #linebreak() $u$; $(16, 1)$],
  [$173$], [$[u]$], [$53$], [$ZZ_173 times C_88 times C_2$], [$(2,35),(95,0)$], [$148$ #linebreak() $-10388 slash 289$], [$u$; $(39, 0)$ #linebreak() $u$; $(64, 1)$],
  [$173$], [$[p]$], [$-173$], [$ZZ_173 times C_2 times C_2$], [$8 p, 37 p$], [$4671 slash 25$ #linebreak() $84078 slash 289$], [$u$; $(1, 0)$ #linebreak() $u$; $(0, 1)$],
  [$173$], [$[u p]$], [$519$], [$ZZ_173 times C_2 times C_2$], [$62 p, 135 p$], [$3633 slash 4$ #linebreak() $-1211 slash 25$], [$u$; $(0, 1)$ #linebreak() $u$; $(1, 0)$],
  [$179$], [$[1]$], [$1$], [$ZZ_179 times C_180$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$179$], [$[u]$], [$-19$], [$ZZ_179 times C_180$], [$(6,78)$], [$9772 slash 361$], [$u$; $(161)$],
  [$179$], [$[p]$], [$179$], [$ZZ_179 times C_2$], [---], [$21659 slash 169$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$179$], [$[u p]$], [$-537$], [$ZZ_179 times C_2$], [---], [$1428490275232098 slash 2937758292121$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$181$], [$[1]$], [$1$], [$ZZ_181 times C_190$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$181$], [$[u]$], [$7$], [$ZZ_181 times C_174$], [$(4,28)$], [$-3$], [$u$; $(73)$],
  [$181$], [$[p]$], [$-181$], [$ZZ_181 times C_2$], [---], [$1267 slash 9$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$181$], [$[u p]$], [$-1086$], [$ZZ_181 times C_2$], [---], [$113125 slash 121$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$191$], [$[1]$], [$1$], [$ZZ_191 times C_217$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$191$], [$[u]$], [$-1$], [$ZZ_191 times C_167$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$191$], [$[p]$], [$191$], [$ZZ_191$], [---], [$147421 slash 49$], [$u$; ---],
  [$191$], [$[u p]$], [$-191$], [$ZZ_191$], [---], [$32463476400 slash 184334929$], [$u$; ---],
  [$193$], [$[1]$], [$1$], [$ZZ_193 times C_201$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$193$], [$[u]$], [$5$], [$ZZ_193 times C_187$], [$(4,17)$], [$4$], [$u$; $(1)$],
  [$193$], [$[p]$], [$-193$], [$ZZ_193$], [---], [$9866360014417 slash 20332193281$], [$u$; ---],
  [$193$], [$[u p]$], [$965$], [$ZZ_193$], [---], [$99428383084 slash 1100401$], [$u$; ---],
  [$197$], [$[1]$], [$-6$], [$ZZ_197 times C_222$], [$(2,88)$], [$21$], [$u$; $(85)$],
  [$197$], [$[u]$], [$3$], [$ZZ_197 times C_174$], [$(2,29)$], [$3$], [$u$; $(91)$],
  [$197$], [$[p]$], [$197$], [$ZZ_197 times C_2$], [---], [$237188 slash 289$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$197$], [$[u p]$], [$394$], [$ZZ_197 times C_2$], [---], [$55718377785 slash 34175716$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$199$], [$[1]$], [$-6$], [$ZZ_199 times C_218$], [$(5,41)$], [$21$], [$u$; $(123)$],
  [$199$], [$[u]$], [$3$], [$ZZ_199 times C_182$], [$(3,9)$], [$3$], [$u$; $(1)$],
  [$199$], [$[p]$], [$199$], [$ZZ_199 times C_2$], [---], [$-995 slash 9$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$199$], [$[u p]$], [$-199$], [$ZZ_199 times C_2$], [---], [$6169 slash 16$], [$u$; ord $2$ in $C_2$#super[\*]],
...
two the search returned). The $34$ lines with $E^d (QQ_p) tilde.equiv ZZ_p$ are the additive
classes with $c_p = 1$, where the torsion vanishes entirely.
...
#table(
  ...
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 3$, class $[1]$, $d = 7$ #h(12pt) $x(P_1) = -3$],
  [$3$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 3$, class $[u]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$3$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 3$, class $[p]$, $d = 3$ #h(12pt) $x(P_1) = 3$],
  [$3$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 3$, class $[u p]$, $d = 6$ #h(12pt) $x(P_1) = -3$],
  [$3$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 5$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$5$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$3$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 5$, class $[u]$, $d = 3$ #h(12pt) $x(P_1) = 3$],
  [$5$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$3$], [$1$], [$(3,1)$], [$P_1 |-> (2)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 5$, class $[p]$, $d = 5$ #h(12pt) $x(P_1) = 4$],
  [$5$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 5$, class $[u p]$, $d = -35$ #h(12pt) $x(P_1) = 59004/1369$],
  [$5$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 7$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$7$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$5$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 7$, class $[u]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$7$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$11$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 7$, class $[p]$, $d = 7$ #h(12pt) $x(P_1) = -3$],
  [$7$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 7$, class $[u p]$, $d = -7$ #h(12pt) $x(P_1) = 424/25$],
  [$7$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 11$, class $[1]$, $d = 3$ #h(12pt) $x(P_1) = 3$],
  [$11$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(1,2)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$7$], [$1$], [$(1,2)$], [$P_1 |-> (3)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 11$, class $[u]$, $d = 6$ #h(12pt) $x(P_1) = -3$],
  [$11$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(8,2)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$5$], [$1$], [$(8,2)$], [$P_1 |-> (4)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 11$, class $[p]$, $d = 11$ #h(12pt) $x(P_1) = 22$],
  [$11$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 11$, class $[u p]$, $d = -11$ #h(12pt) $x(P_1) = 33/4$, $x(P_2) = 220$],
  [$11$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$;#h(4pt) $P_2 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 13$, class $[1]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$13$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 13$, class $[u]$, $d = 5$ #h(12pt) $x(P_1) = 4$],
  [$13$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(2,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$5$], [$1$], [$(2,1)$], [$P_1 |-> (3)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 13$, class $[p]$, $d = -13$ #h(12pt) $x(P_1) = 247$],
  [$13$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 13$, class $[u p]$, $d = 26$ #h(12pt) $x(P_1) = 13$],
  [$13$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 17$, class $[1]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$17$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(0,4)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(0,4)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 17$, class $[u]$, $d = 7$ #h(12pt) $x(P_1) = -3$],
  [$17$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(14,4)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(14,4)$], [$P_1 |-> (2)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 17$, class $[p]$, $d = 34$ #h(12pt) $x(P_1) = 85$],
  [$17$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 17$, class $[u p]$, $d = 51$ #h(12pt) $x(P_1) = -17$, $x(P_2) = -714/25$],
  [$17$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$;#h(4pt) $P_2 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 19$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$19$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$3$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$7$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 19$, class $[u]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$19$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 19$, class $[p]$, $d = 95$ #h(12pt) $x(P_1) = 59101/121$],
  [$19$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 19$, class $[u p]$, $d = -95$ #h(12pt) $x(P_1) = 3723268224/6105841$],
  [$19$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 23$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$23$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$7$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 23$, class $[u]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$23$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$5$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 23$, class $[p]$, $d = 46$ #h(12pt) $x(P_1) = 3381/625$],
  [$23$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 23$, class $[u p]$, $d = 115$ #h(12pt) $x(P_1) = -69$],
  [$23$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 29$, class $[1]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$29$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 29$, class $[u]$, $d = 11$ #h(12pt) $x(P_1) = 22$],
  [$29$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(4,9)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(4,9)$], [$P_1 |-> (2)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 29$, class $[p]$, $d = -29$ #h(12pt) $x(P_1) = 87$],
  [$29$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 29$, class $[u p]$, $d = 58$ #h(12pt) $x(P_1) = -72682323/1885129$],
  [$29$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 31$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$31$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(32)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 31$, class $[u]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$31$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(30)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [gen. of $C_(30)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$5$], [$1$], [gen. of $C_(30)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 31$, class $[p]$, $d = 31$ #h(12pt) $x(P_1) = 93$],
  [$31$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 31$, class $[u p]$, $d = -62$ #h(12pt) $x(P_1) = 93$],
  [$31$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(4)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 37$, class $[1]$, $d = -11$ #h(12pt) $x(P_1) = 33/4$, $x(P_2) = 220$],
  ...
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 37$, class $[u]$, $d = 6$ #h(12pt) $x(P_1) = -3$],
  [$37$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(7,16)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$7$], [$1$], [$(7,16)$], [$P_1 |-> (5)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 37$, class $[p]$, $d = -37$ #h(12pt) $x(P_1) = 8473/16$],
  [$37$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 37$, class $[u p]$, $d = 74$ #h(12pt) $x(P_1) = 91945/1156$],
  [$37$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 41$, class $[1]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$41$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$5$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$7$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 41$, class $[u]$, $d = 3$ #h(12pt) $x(P_1) = 3$],
  [$41$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$7$], [$1$], [$(1,18)$], [$P_1 |-> (6)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 41$, class $[p]$, $d = 41$ #h(12pt) $x(P_1) = -1328/121$],
  [$41$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 41$, class $[u p]$, $d = 123$ #h(12pt) $x(P_1) = 9146571/625$],
  [$41$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 43$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$43$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$17$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 43$, class $[u]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$43$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 43$, class $[p]$, $d = -86$ #h(12pt) $x(P_1) = 26445/169$],
  [$43$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 43$, class $[u p]$, $d = 86$ #h(12pt) $x(P_1) = -169979/47089$],
  [$43$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 47$, class $[1]$, $d = -11$ #h(12pt) $x(P_1) = 33/4$, $x(P_2) = 220$],
  ...
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 47$, class $[u]$, $d = -149$ #h(12pt) $x(P_1) = 1639$, $x(P_2) = 8791/25$],
  [$47$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$2$], [$(3,6)$, $(2,0)$], [$P_1 |-> (0, 1)$;#h(4pt) $P_2 |-> (1, 1)$], [$2$], [onto],
  [$3$], [$1$], [$(3,6)$], [$P_1 |-> (0)$;#h(4pt) $P_2 |-> (2)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 47$, class $[p]$, $d = 94$ #h(12pt) $x(P_1) = 141$, $x(P_2) = 1833/16$],
  [$47$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$2$], [$(3 p, 0)$, $(21 p, 0)$], [$P_1 |-> (1, 0)$;#h(4pt) $P_2 |-> (1, 1)$], [$2$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 47$, class $[u p]$, $d = 705$ #h(12pt) $x(P_1) = 376$, $x(P_2) = -2439159/6400$],
  [$47$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$2$], [$(8 p, 0)$, $(40 p, 0)$], [$P_1 |-> (1, 0)$;#h(4pt) $P_2 |-> (0, 1)$], [$2$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 53$, class $[1]$, $d = 11$ #h(12pt) $x(P_1) = 22$],
  [$53$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(2,16)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$29$], [$1$], [$(2,16)$], [$P_1 |-> (4)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 53$, class $[u]$, $d = 22$ #h(12pt) $x(P_1) = 2937/196$],
  [$53$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(2,21)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$5$], [$1$], [$(2,21)$], [$P_1 |-> (3)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 53$, class $[p]$, $d = 53$ #h(12pt) $x(P_1) = 148$, $x(P_2) = -10388/289$],
  [$53$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (0)$;#h(4pt) $P_2 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 53$, class $[u p]$, $d = 106$ #h(12pt) $x(P_1) = 25798969/7396$],
  [$53$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 59$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$59$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$3$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$7$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 59$, class $[u]$, $d = 6$ #h(12pt) $x(P_1) = -3$],
  [$59$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$3$], [$1$], [$(1,28)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$19$], [$1$], [$(1,28)$], [$P_1 |-> (8)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 59$, class $[p]$, $d = 295$ #h(12pt) $x(P_1) = 8251821/49$],
  [$59$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 59$, class $[u p]$, $d = -59$ #h(12pt) $x(P_1) = 217697199204/5358093601$],
  [$59$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 61$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$61$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$5$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 61$, class $[u]$, $d = 7$ #h(12pt) $x(P_1) = -3$],
  [$61$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(5,15)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$37$], [$1$], [$(5,15)$], [$P_1 |-> (22)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 61$, class $[p]$, $d = -61$ #h(12pt) $x(P_1) = 10675/81$],
  [$61$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 61$, class $[u p]$, $d = 122$ #h(12pt) $x(P_1) = 2358325453/110889$],
  [$61$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 67$, class $[1]$, $d = -221$ #h(12pt) $x(P_1) = 1326$, $x(P_2) = 1819/9$],
  ...
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 67$, class $[u]$, $d = 51$ #h(12pt) $x(P_1) = -17$, $x(P_2) = -714/25$],
  [$67$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$2$], [$(1,28)$, $(10,0)$], [$P_1 |-> (1, 1)$;#h(4pt) $P_2 |-> (0, 1)$], [$2$], [onto],
  [$5$], [$1$], [$(1,28)$], [$P_1 |-> (4)$;#h(4pt) $P_2 |-> (3)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 67$, class $[p]$, $d = 2211$ #h(12pt) $x(P_1) = 28743$, $x(P_2) = 4623$],
  [$67$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$2$], [$(2 p, 0)$, $(27 p, 0)$], [$P_1 |-> (0, 1)$;#h(4pt) $P_2 |-> (1, 0)$], [$2$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 67$, class $[u p]$, $d = 134$ #h(12pt) $x(P_1) = -335/4$, $x(P_2) = 94537/196$],
  [$67$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$2$], [$(26 p, 0)$, $(49 p, 0)$], [$P_1 |-> (0, 1)$;#h(4pt) $P_2 |-> (1, 0)$], [$2$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 71$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$71$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$59$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 71$, class $[u]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$71$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$5$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$17$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 71$, class $[p]$, $d = 71$ #h(12pt) $x(P_1) = -47$],
  [$71$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 71$, class $[u p]$, $d = -71$ #h(12pt) $x(P_1) = 334272/6889$],
  [$71$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 73$, class $[1]$, $d = 3$ #h(12pt) $x(P_1) = 3$],
  [$73$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(3,9)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(3,9)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 73$, class $[u]$, $d = -21$ #h(12pt) $x(P_1) = 15$],
  [$73$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(6,5)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$19$], [$1$], [$(6,5)$], [$P_1 |-> (12)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 73$, class $[p]$, $d = 146$ #h(12pt) $x(P_1) = 7081/64$],
  [$73$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 73$, class $[u p]$, $d = -365$ #h(12pt) $x(P_1) = 121326/169$],
  [$73$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 79$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$79$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$43$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 79$, class $[u]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$79$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$37$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 79$, class $[p]$, $d = 158$ #h(12pt) $x(P_1) = 5004161712613/72071308521$],
  [$79$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 79$, class $[u p]$, $d = -158$ #h(12pt) $x(P_1) = 7760048840149/57386598025$],
  [$79$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 83$, class $[1]$, $d = -22$ #h(12pt) $x(P_1) = 1177/64$],
  [$83$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(9,9)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(9,9)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$5$], [$1$], [$(9,9)$], [$P_1 |-> (3)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 83$, class $[u]$, $d = -11$ #h(12pt) $x(P_1) = 33/4$, $x(P_2) = 220$],
  ...
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 83$, class $[p]$, $d = 83$ #h(12pt) $x(P_1) = 115702/9$],
  [$83$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 83$, class $[u p]$, $d = 166$ #h(12pt) $x(P_1) = -7055/64$],
  [$83$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 89$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$89$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$5$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 89$, class $[u]$, $d = -7$ #h(12pt) $x(P_1) = 424/25$],
  [$89$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(3,3)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$5$], [$1$], [$(3,3)$], [$P_1 |-> (2)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 89$, class $[p]$, $d = 178$ #h(12pt) $x(P_1) = 50010613/58081$],
  [$89$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 89$, class $[u p]$, $d = -267$ #h(12pt) $x(P_1) = 13439267253561/39505537600$],
  [$89$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 97$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$97$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 97$, class $[u]$, $d = 7$ #h(12pt) $x(P_1) = -3$],
  [$97$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$3$], [$1$], [$(2,35)$], [$P_1 |-> (2)$], [$1$], [onto],
  [$11$], [$1$], [$(2,35)$], [$P_1 |-> (9)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 97$, class $[p]$, $d = 97$ #h(12pt) $x(P_1) = -3020977264272/60834742609$],
  [$97$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 97$, class $[u p]$, $d = 485$ #h(12pt) $x(P_1) = 607367181296288749204/261353291940472081$],
  [$97$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 101$, class $[1]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$101$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$3$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$5$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$7$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 101$, class $[u]$, $d = 3$ #h(12pt) $x(P_1) = 3$],
  [$101$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$3$], [$1$], [$(3,9)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$11$], [$1$], [$(3,9)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 101$, class $[p]$, $d = 101$ #h(12pt) $x(P_1) = -68$],
  [$101$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 101$, class $[u p]$, $d = -2626$ #h(12pt) $x(P_1) = 80987149350133/43587835729$],
  [$101$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 103$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$103$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$3$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$29$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 103$, class $[u]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$103$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$11$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 103$, class $[p]$, $d = 103$ #h(12pt) $x(P_1) = 1433661/625$],
  [$103$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 103$, class $[u p]$, $d = 2266$ #h(12pt) $x(P_1) = -811896233775/535089424$],
  [$103$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 107$, class $[1]$, $d = -7$ #h(12pt) $x(P_1) = 424/25$],
  [$107$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$3$], [$1$], [$(13,43)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$5$], [$1$], [$(13,43)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$7$], [$1$], [$(13,43)$], [$P_1 |-> (4)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 107$, class $[u]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$107$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$3$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$37$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 107$, class $[p]$, $d = -1605$ #h(12pt) $x(P_1) = 2571$],
  [$107$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 107$, class $[u p]$, $d = -107$ #h(12pt) $x(P_1) = 348$],
  [$107$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 109$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$109$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$3$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$41$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 109$, class $[u]$, $d = 6$ #h(12pt) $x(P_1) = -3$],
  [$109$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$97$], [$1$], [$(1,12)$], [$P_1 |-> (63)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 109$, class $[p]$, $d = 109$ #h(12pt) $x(P_1) = 33919060748052/93717413689$],
  [$109$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 109$, class $[u p]$, $d = 654$ #h(12pt) $x(P_1) = 15870885/6889$],
  [$109$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 113$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$113$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$5$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 113$, class $[u]$, $d = 3$ #h(12pt) $x(P_1) = 3$],
  [$113$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$103$], [$1$], [$(2,36)$], [$P_1 |-> (13)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 113$, class $[p]$, $d = 113$ #h(12pt) $x(P_1) = -160779984385773438752/2170759046766859201$],
  [$113$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 113$, class $[u p]$, $d = 339$ #h(12pt) $x(P_1) = -129$],
  [$113$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 127$, class $[1]$, $d = -6$ #h(12pt) $x(P_1) = 21$],
  [$127$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(15,4)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(15,4)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$7$], [$1$], [$(15,4)$], [$P_1 |-> (2)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 127$, class $[u]$, $d = 3$ #h(12pt) $x(P_1) = 3$],
  [$127$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(3,9)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$5$], [$1$], [$(3,9)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$13$], [$1$], [$(3,9)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 127$, class $[p]$, $d = 254$ #h(12pt) $x(P_1) = 39963217/20164$],
  [$127$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 127$, class $[u p]$, $d = -127$ #h(12pt) $x(P_1) = 88$, $x(P_2) = 3122041/25600$],
  [$127$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (0)$;#h(4pt) $P_2 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 131$, class $[1]$, $d = 53$ #h(12pt) $x(P_1) = 148$, $x(P_2) = -10388/289$],
  [$131$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$2$], [$(0,42)$, $(3,0)$], [$P_1 |-> (1, 0)$;#h(4pt) $P_2 |-> (1, 1)$], [$2$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 131$, class $[u]$, $d = -11$ #h(12pt) $x(P_1) = 33/4$, $x(P_2) = 220$],
  [$131$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$2$], [$(3,32)$, $(76,0)$], [$P_1 |-> (1, 1)$;#h(4pt) $P_2 |-> (1, 0)$], [$2$], [onto],
  [$17$], [$1$], [$(3,32)$], [$P_1 |-> (7)$;#h(4pt) $P_2 |-> (8)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 131$, class $[p]$, $d = 131$ #h(12pt) $x(P_1) = 655$, $x(P_2) = 5371/25$],
  [$131$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$2$], [$(5 p, 0)$, $(51 p, 0)$], [$P_1 |-> (1, 0)$;#h(4pt) $P_2 |-> (1, 1)$], [$2$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 131$, class $[u p]$, $d = 8646$ #h(12pt) $x(P_1) = 80565$, $x(P_2) = -29168680211/7425625$],
  [$131$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$2$], [$(68 p, 0)$, $(91 p, 0)$], [$P_1 |-> (0, 1)$;#h(4pt) $P_2 |-> (1, 1)$], [$2$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 137$, class $[1]$, $d = 7$ #h(12pt) $x(P_1) = -3$],
  [$137$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(5,24)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(5,24)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$7$], [$1$], [$(5,24)$], [$P_1 |-> (6)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 137$, class $[u]$, $d = 3$ #h(12pt) $x(P_1) = 3$],
  [$137$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(3,9)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(3,9)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$5$], [$1$], [$(3,9)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 137$, class $[p]$, $d = 274$ #h(12pt) $x(P_1) = 331123731117/5803544761$],
  [$137$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 137$, class $[u p]$, $d = -411$ #h(12pt) $x(P_1) = 1101728244/3508129$],
  [$137$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 139$, class $[1]$, $d = 51$ #h(12pt) $x(P_1) = -17$, $x(P_2) = -714/25$],
  ...
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 139$, class $[u]$, $d = 3$ #h(12pt) $x(P_1) = 3$],
  [$139$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(1,68)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$7$], [$1$], [$(1,68)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$11$], [$1$], [$(1,68)$], [$P_1 |-> (5)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 139$, class $[p]$, $d = 139$ #h(12pt) $x(P_1) = 417/4$],
  [$139$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 139$, class $[u p]$, $d = -139$ #h(12pt) $x(P_1) = 3892/9$, $x(P_2) = 148204$],
  [$139$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$;#h(4pt) $P_2 |-> (0)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 149$, class $[1]$, $d = 53$ #h(12pt) $x(P_1) = 148$, $x(P_2) = -10388/289$],
  ...
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 149$, class $[u]$, $d = 94$ #h(12pt) $x(P_1) = 141$, $x(P_2) = 1833/16$],
  [$149$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$2$], [$(1,36)$, $(40,0)$], [$P_1 |-> (0, 1)$;#h(4pt) $P_2 |-> (1, 0)$], [$2$], [onto],
  [$41$], [$1$], [$(1,36)$], [$P_1 |-> (9)$;#h(4pt) $P_2 |-> (5)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 149$, class $[p]$, $d = -149$ #h(12pt) $x(P_1) = 1639$, $x(P_2) = 8791/25$],
  [$149$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$2$], [$(11 p, 0)$, $(56 p, 0)$], [$P_1 |-> (1, 0)$;#h(4pt) $P_2 |-> (0, 1)$], [$2$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 149$, class $[u p]$, $d = 13559$ #h(12pt) $x(P_1) = 20413$, $x(P_2) = 712634381069/37982569$],
  [$149$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$2$], [$(42 p, 0)$, $(119 p, 0)$], [$P_1 |-> (1, 1)$;#h(4pt) $P_2 |-> (0, 1)$], [$2$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 151$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$151$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$7$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$11$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 151$, class $[u]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$151$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$5$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 151$, class $[p]$, $d = 755$ #h(12pt) $x(P_1) = 151$],
  [$151$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 151$, class $[u p]$, $d = 453$ #h(12pt) $x(P_1) = 3366104446853292/32473665853489$],
  [$151$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 157$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$157$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$3$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$19$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 157$, class $[u]$, $d = 5$ #h(12pt) $x(P_1) = 4$],
  [$157$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$5$], [$1$], [$(4,17)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$29$], [$1$], [$(4,17)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 157$, class $[p]$, $d = 157$ #h(12pt) $x(P_1) = 4195788/2809$],
  [$157$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 157$, class $[u p]$, $d = 2355$ #h(12pt) $x(P_1) = 22623639965396331/4382453351761$],
  [$157$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 163$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$163$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$3$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$7$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 163$, class $[u]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$163$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$139$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 163$, class $[p]$, $d = 978$ #h(12pt) $x(P_1) = 933$],
  [$163$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 163$, class $[u p]$, $d = 815$ #h(12pt) $x(P_1) = -2464911059/18309841$],
  [$163$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 167$, class $[1]$, $d = -13$ #h(12pt) $x(P_1) = 247$],
  [$167$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(3,72)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(3,72)$], [$P_1 |-> (2)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 167$, class $[u]$, $d = -6$ #h(12pt) $x(P_1) = 21$],
  [$167$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(2,71)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(2,71)$], [$P_1 |-> (2)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 167$, class $[p]$, $d = 334$ #h(12pt) $x(P_1) = 58617/4$],
  [$167$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 167$, class $[u p]$, $d = -334$ #h(12pt) $x(P_1) = 743828521/1444804$],
  [$167$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 173$, class $[1]$, $d = 51$ #h(12pt) $x(P_1) = -17$, $x(P_2) = -714/25$],
  ...
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 173$, class $[u]$, $d = 53$ #h(12pt) $x(P_1) = 148$, $x(P_2) = -10388/289$],
  [$173$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$2$], [$(2,35)$, $(95,0)$], [$P_1 |-> (1, 0)$;#h(4pt) $P_2 |-> (0, 1)$], [$2$], [onto],
  [$11$], [$1$], [$(2,35)$], [$P_1 |-> (6)$;#h(4pt) $P_2 |-> (9)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 173$, class $[p]$, $d = -173$ #h(12pt) $x(P_1) = 4671/25$, $x(P_2) = 84078/289$],
  [$173$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$2$], [$(8 p, 0)$, $(37 p, 0)$], [$P_1 |-> (1, 0)$;#h(4pt) $P_2 |-> (0, 1)$], [$2$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 173$, class $[u p]$, $d = 519$ #h(12pt) $x(P_1) = 3633/4$, $x(P_2) = -1211/25$],
  [$173$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$2$], [$(62 p, 0)$, $(135 p, 0)$], [$P_1 |-> (0, 1)$;#h(4pt) $P_2 |-> (1, 0)$], [$2$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 179$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$179$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$5$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 179$, class $[u]$, $d = -19$ #h(12pt) $x(P_1) = 9772/361$],
  [$179$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(6,78)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(6,78)$], [$P_1 |-> (2)$], [$1$], [onto],
  [$5$], [$1$], [$(6,78)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 179$, class $[p]$, $d = 179$ #h(12pt) $x(P_1) = 21659/169$],
  [$179$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 179$, class $[u p]$, $d = -537$ #h(12pt) $x(P_1) = 1428490275232098/2937758292121$],
  [$179$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 181$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$181$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$5$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$19$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 181$, class $[u]$, $d = 7$ #h(12pt) $x(P_1) = -3$],
  [$181$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(4,28)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(4,28)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$29$], [$1$], [$(4,28)$], [$P_1 |-> (15)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 181$, class $[p]$, $d = -181$ #h(12pt) $x(P_1) = 1267/9$],
  [$181$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 181$, class $[u p]$, $d = -1086$ #h(12pt) $x(P_1) = 113125/121$, $x(P_2) = 1072425/1024$],
  [$181$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$;#h(4pt) $P_2 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 191$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$191$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$7$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$31$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 191$, class $[u]$, $d = -1$ #h(12pt) $x(P_1) = 1$],
  [$191$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$167$], [$1$], [$(1,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 191$, class $[p]$, $d = 191$ #h(12pt) $x(P_1) = 147421/49$],
  [$191$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 191$, class $[u p]$, $d = -191$ #h(12pt) $x(P_1) = 32463476400/184334929$],
  [$191$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 193$, class $[1]$, $d = 1$ #h(12pt) $x(P_1) = 0$],
  [$193$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$3$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$67$], [$1$], [$(0,1)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 193$, class $[u]$, $d = 5$ #h(12pt) $x(P_1) = 4$],
  [$193$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$11$], [$1$], [$(4,17)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$17$], [$1$], [$(4,17)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 193$, class $[p]$, $d = -193$ #h(12pt) $x(P_1) = 9866360014417/20332193281$],
  [$193$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 193$, class $[u p]$, $d = 965$ #h(12pt) $x(P_1) = 99428383084/1100401$],
  [$193$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 197$, class $[1]$, $d = -6$ #h(12pt) $x(P_1) = 21$],
  [$197$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(2,88)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(2,88)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$37$], [$1$], [$(2,88)$], [$P_1 |-> (11)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 197$, class $[u]$, $d = 3$ #h(12pt) $x(P_1) = 3$],
  [$197$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(2,29)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$3$], [$1$], [$(2,29)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$29$], [$1$], [$(2,29)$], [$P_1 |-> (4)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 197$, class $[p]$, $d = 197$ #h(12pt) $x(P_1) = 237188/289$, $x(P_2) = -398636/3025$],
  [$197$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$;#h(4pt) $P_2 |-> (0)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 197$, class $[u p]$, $d = 394$ #h(12pt) $x(P_1) = 55718377785/34175716$],
  [$197$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 199$, class $[1]$, $d = -6$ #h(12pt) $x(P_1) = 21$],
  [$199$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(5,41)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$109$], [$1$], [$(5,41)$], [$P_1 |-> (14)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 199$, class $[u]$, $d = 3$ #h(12pt) $x(P_1) = 3$],
  [$199$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [$(3,9)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$7$], [$1$], [$(3,9)$], [$P_1 |-> (1)$], [$1$], [onto],
  [$13$], [$1$], [$(3,9)$], [$P_1 |-> (1)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 199$, class $[p]$, $d = 199$ #h(12pt) $x(P_1) = -995/9$, $x(P_2) = 33$],
  [$199$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$;#h(4pt) $P_2 |-> (0)$], [$1$], [onto],
  table.cell(colspan: 6, fill: luma(242))[#h(1pt) $p = 199$, class $[u p]$, $d = -199$ #h(12pt) $x(P_1) = 6169/16$, $x(P_2) = 18144424/109561$],
  [$199$#super[d]], [$1$], [--- (dim $1$)], [$P_1 |-> eq.not 0$;#h(4pt) $P_2 |-> eq.not 0$], [$1$], [onto],
  [$2$], [$1$], [gen. of $C_(2)$], [$P_1 |-> (1)$;#h(4pt) $P_2 |-> (0)$], [$1$], [onto],
)
#set text(size: 10.5pt)
