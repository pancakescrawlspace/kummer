...
#table(
  ...
  [$3$], [$[p]$], [$3$], [$ZZ_p times C_2$], [---], [$3$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$3$], [$[u p]$], [$6$], [$ZZ_p times C_2$], [---], [$-3$], [$u$; ord $2$ in $C_2$#super[\*]],
  ...
  [$11$], [$[p]$], [$11$], [$ZZ_p times C_2$], [---], [$22$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$11$], [$[u p]$], [$-11$], [$ZZ_p times C_2$], [---], [$33 slash 4$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$13$], [$[1]$], [$-1$], [$ZZ_p times C_18$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$13$], [$[u]$], [$5$], [$ZZ_p times C_10$], [$(2,1)$], [$4$], [$u$; $(3)$],
  [$13$], [$[p]$], [$-13$], [$ZZ_p times C_2$], [---], [$247$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$13$], [$[u p]$], [$26$], [$ZZ_p times C_2$], [---], [$13$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$17$], [$[1]$], [$-1$], [$ZZ_p times C_18$], [$(0,4)$], [$1$], [$u$; $(13)$],
  [$17$], [$[u]$], [$7$], [$ZZ_p times C_18$], [$(14,4)$], [$-3$], [$u$; $(17)$],
  [$17$], [$[p]$], [$34$], [$ZZ_p times C_2$], [---], [$85$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$17$], [$[u p]$], [$51$], [$ZZ_p times C_2$], [---], [$-17$], [$u$; ord $2$ in $C_2$#super[\*]],
  ...
  [$23$], [$[p]$], [$46$], [$ZZ_p times C_2$], [---], [$3381 slash 625$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$23$], [$[u p]$], [$115$], [$ZZ_p times C_2$], [---], [$-69$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$29$], [$[1]$], [$-1$], [$ZZ_p times C_36$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$29$], [$[u]$], [$11$], [$ZZ_p times C_24$], [$(4,9)$], [$22$], [$u$; $(5)$],
  [$29$], [$[p]$], [$-29$], [$ZZ_p times C_2$], [---], [$87$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$29$], [$[u p]$], [$58$], [$ZZ_p times C_2$], [---], [$-72682323 slash 1885129$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$31$], [$[1]$], [$1$], [$ZZ_p times C_32$], [---], [$0$], [$u$; ord $32$ in $C_32$#super[\*]],
  [$31$], [$[u]$], [$-1$], [$ZZ_p times C_30$], [---], [$1$], [$u$; ord $30$ in $C_30$#super[\*]],
  [$31$], [$[p]$], [$31$], [$ZZ_p times C_2$], [---], [$93$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$31$], [$[u p]$], [$-62$], [$ZZ_p times C_4$], [---], [$93$], [$u$; ord $4$ in $C_4$#super[\*]],
  [$37$], [$[1]$], [$-11$], [$ZZ_p times C_48$], [$(1,7)$], [$220$], [$u$; $(19)$],
  [$37$], [$[u]$], [$6$], [$ZZ_p times C_28$], [$(7,16)$], [$-3$], [$u$; $(5)$],
  [$37$], [$[p]$], [$-37$], [$ZZ_p times C_2$], [---], [$8473 slash 16$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$37$], [$[u p]$], [$74$], [$ZZ_p times C_2$], [---], [$91945 slash 1156$], [$u$; ord $2$ in $C_2$#super[\*]],
  ...
  [$43$], [$[p]$], [$-86$], [$ZZ_p times C_2$], [---], [$26445 slash 169$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$43$], [$[u p]$], [$86$], [$ZZ_p times C_2$], [---], [$-169979 slash 47089$], [$u$; ord $2$ in $C_2$#super[\*]],
  ...
  [$53$], [$[p]$], [$53$], [$ZZ_p times C_2$], [---], [$-10388 slash 289$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$53$], [$[u p]$], [$106$], [$ZZ_p times C_2$], [---], [$25798969 slash 7396$], [$u$; ord $2$ in $C_2$#super[\*]],
  ...
  [$61$], [$[p]$], [$-61$], [$ZZ_p times C_2$], [---], [$10675 slash 81$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$61$], [$[u p]$], [$122$], [$ZZ_p times C_2$], [---], [$2358325453 slash 110889$], [$u$; ord $2$ in $C_2$#super[\*]],
  ...
  [$73$], [$[p]$], [$146$], [$ZZ_p times C_2$], [---], [$7081 slash 64$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$73$], [$[u p]$], [$-365$], [$ZZ_p times C_2$], [---], [$121326 slash 169$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$79$], [$[1]$], [$1$], [$ZZ_p times C_86$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$79$], [$[u]$], [$-1$], [$ZZ_p times C_74$], [$(1,1)$], [$1$], [$u$; $(1)$],
  [$79$], [$[p]$], [$158$], [$ZZ_p times C_2$], [---], [$5004161712613 slash 72071308521$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$79$], [$[u p]$], [$-158$], [$ZZ_p times C_2$], [---], [$7760048840149 slash 57386598025$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$83$], [$[1]$], [$-22$], [$ZZ_p times C_90$], [$(9,9)$], [$1177 slash 64$], [$u$; $(13)$],
  [$83$], [$[u]$], [$-11$], [$ZZ_p times C_78$], [$(2,9)$], [$33 slash 4$ #linebreak() $220$], [$u$; $(51)$ #linebreak() $u$; $(13)$],
  [$83$], [$[p]$], [$83$], [$ZZ_p times C_2$], [---], [$115702 slash 9$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$83$], [$[u p]$], [$166$], [$ZZ_p times C_2$], [---], [$-7055 slash 64$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$89$], [$[1]$], [$1$], [$ZZ_p times C_100$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$89$], [$[u]$], [$-7$], [$ZZ_p times C_80$], [$(3,3)$], [$424 slash 25$], [$u$; $(57)$],
  [$89$], [$[p]$], [$178$], [$ZZ_p times C_2$], [---], [$50010613 slash 58081$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$89$], [$[u p]$], [$-267$], [$ZZ_p times C_2$], [---], [$13439267253561 slash 39505537600$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$97$], [$[1]$], [$1$], [$ZZ_p$], [---], [$0$], [$u$; ---],
  ...
  [$127$], [$[p]$], [$254$], [$ZZ_p times C_2$], [---], [$39963217 slash 20164$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$127$], [$[u p]$], [$-127$], [$ZZ_p times C_2$], [---], [$3122041 slash 25600$], [$u$; ord $2$ in $C_2$#super[\*]],
  ...
  [$137$], [$[p]$], [$274$], [$ZZ_p times C_2$], [---], [$331123731117 slash 5803544761$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$137$], [$[u p]$], [$-411$], [$ZZ_p times C_2$], [---], [$1101728244 slash 3508129$], [$u$; ord $2$ in $C_2$#super[\*]],
  ...
  [$139$], [$[p]$], [$139$], [$ZZ_p times C_2$], [---], [$417 slash 4$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$139$], [$[u p]$], [$-139$], [$ZZ_p times C_2$], [---], [$3892 slash 9$], [$u$; ord $2$ in $C_2$#super[\*]],
  ...
  [$151$], [$[p]$], [$755$], [$ZZ_p times C_2$], [---], [$151$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$151$], [$[u p]$], [$453$], [$ZZ_p times C_2$], [---], [$3366104446853292 slash 32473665853489$], [$u$; ord $2$ in $C_2$#super[\*]],
  ...
  [$167$], [$[p]$], [$334$], [$ZZ_p times C_2$], [---], [$58617 slash 4$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$167$], [$[u p]$], [$-334$], [$ZZ_p times C_2$], [---], [$743828521 slash 1444804$], [$u$; ord $2$ in $C_2$#super[\*]],
  ...
  [$179$], [$[p]$], [$179$], [$ZZ_p times C_2$], [---], [$21659 slash 169$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$179$], [$[u p]$], [$-537$], [$ZZ_p times C_2$], [---], [$1428490275232098 slash 2937758292121$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$181$], [$[1]$], [$1$], [$ZZ_p times C_190$], [$(0,1)$], [$0$], [$u$; $(1)$],
  [$181$], [$[u]$], [$7$], [$ZZ_p times C_174$], [$(4,28)$], [$-3$], [$u$; $(73)$],
  [$181$], [$[p]$], [$-181$], [$ZZ_p times C_2$], [---], [$1267 slash 9$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$181$], [$[u p]$], [$-1086$], [$ZZ_p times C_2$], [---], [$113125 slash 121$], [$u$; ord $2$ in $C_2$#super[\*]],
  ...
  [$197$], [$[p]$], [$197$], [$ZZ_p times C_2$], [---], [$237188 slash 289$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$197$], [$[u p]$], [$394$], [$ZZ_p times C_2$], [---], [$55718377785 slash 34175716$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$199$], [$[1]$], [$-6$], [$ZZ_p times C_218$], [$(5,41)$], [$21$], [$u$; $(123)$],
  [$199$], [$[u]$], [$3$], [$ZZ_p times C_182$], [$(3,9)$], [$3$], [$u$; $(1)$],
  [$199$], [$[p]$], [$199$], [$ZZ_p times C_2$], [---], [$-995 slash 9$], [$u$; ord $2$ in $C_2$#super[\*]],
  [$199$], [$[u p]$], [$-199$], [$ZZ_p times C_2$], [---], [$6169 slash 16$], [$u$; ord $2$ in $C_2$#super[\*]],
