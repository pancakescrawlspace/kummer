...
#v(1mm)
Each check was also run against deliberately corrupted symbols --- the sign dropped, the two
exponents transposed --- and each then reports failures, so none of the five is passing vacuously.
